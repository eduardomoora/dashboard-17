...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: ()=> import('./dashboard/pages/view-transition/view-transition-1.component').then(c=>c.ViewTransitionComponent)
      },
      {
        path: 'view-transition-2',
        title: 'View Transition',
        loadComponent: ()=> import('./dashboard/pages/view-transition/view-transition-2.component').then(c=>c.ViewTransitionComponent)
      },
      {
        path: 'user/:id',
        title: 'User View',
